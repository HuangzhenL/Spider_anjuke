...
if __name__ == "__main__":
    # citys  = ["nanjing","suzhou","ks","cz","yangzhou","nantong","wuxi","taizhou","xuzhou",
    #          "zhenjiang","yancheng","huaian","lianyungang","shuyang","suqian"]
    # city_names = ["南京","苏州","昆山","常州","扬州","南通","无锡","泰州","徐州",
    #              "镇江","盐城","淮安","连云港","沭阳","宿迁"]
